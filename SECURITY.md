...
If you discover a security vulnerability, please report it privately via [GitHub's private vulnerability reporting](https://github.com/ScottsSecondAct/CollaborativeWhiteboardApp/security/advisories/new).

Include as much of the following as possible:

- Type of issue (e.g. arbitrary code execution, path traversal, information disclosure)
- Steps to reproduce
...
- Issues only reproducible with non-default configurations not present in this repo
